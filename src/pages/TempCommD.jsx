...
const TempCommD = () => {
  ...
  const images = {
    "Suterreni -1": "/prishtina-view/assets/images/commercial/-D.png",
    Suterreni: "/prishtina-view/assets/images/commercial/D.png",
    Përdhesa: "/prishtina-view/assets/images/commercial/D1.png",
  };
          ...
          {Object.keys(images).map((filter) => (
            <button
              ...
              className={`transition-all duration-300 transform px-6 md:px-6 py-1 md:py-2 m-1 md:m-4 inline
                bg-brand text-gold rounded-full text-nowrap ${
                  activeFilter === filter
