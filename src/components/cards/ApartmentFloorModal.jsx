        ...
        >
            ...
            <div className='relative flex flex-col justify-between items-end w-full h-full'>
                <div className="text-right">
                    <p className="text-2xl text-white mb-2">Apartmenti:  {apartment.name}</p>
                    <p className="text-xl opacity-60 text-white">Objekti: {apartment.apartmentNumber}</p>
                </div>
                <div className='flex flex-col'>
                    <h1 className="certon text-5xl text-gold">{apartment.square}m<sup>2</sup></h1>
                </div>
            </div>
        </div>
    );
