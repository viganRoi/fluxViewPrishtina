    ...
    <div className="w-full h-[60vh] flex items-center justify-center py-20 bg-white">
      <div className="w-11/12 md:w-5/6 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 md:pr-12">
          <h3 className="uppercase montserrat text-xs md:text-sm tracking-widest text-gray-500 mb-4">
            Building Icons
          </h3>
          <p className="text-xl montserrat md:text-3xl font-serif leading-relaxed text-brand mb-4">
            At home at the heart of vibrant Dubai, Foleja Group has envisioned
            some of the most{" "}
            <span className="text-xl montserrat md:text-3xl font-serif leading-relaxed text-gold mb-4">
        ...
        <div className="w-full md:w-1/2 md:pl-12">
          <p className="text-sm md:text-base leading-relaxed text-gray-600 mb-12 montserrat">
            ...
            towers to charming low-rise communities, Foleja Group has brought an
            unprecedented level of innovation and experience to Dubai. Carving
            out a distinctive niche in this most dynamic city, Foleja Group
            continues at the cutting edge of architecture, design, and finish.
          </p>
          <button
