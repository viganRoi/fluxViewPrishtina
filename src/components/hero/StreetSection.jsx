  ...
  return (
    <div className="relative w-full h-[80vh] md:h-[120vh] flex items-end justify-start text-white">
      <div
        ...
        style={{
          backgroundImage: `url('/prishtina-view/assets/images/hero/street.png')`,
        }}
      ></div>
      ...
      <div className="absolute top-12 md:top-24 right-10 md:right-20  md:right-20">
        <h1 className="montserrat text-gold text-5xl md:text-7xl">2,4 Ha</h1>
      </div>
      <div className="absolute top-28 md:top-64 right-10 flex gap-6 md:gap-12">
        <div className="flex flex-col items-center justify-center">
          <img
            src="/prishtina-view/assets/svgs/city.svg"
            alt=""
            className="h-12 md:h-24"
          />
          <p className="montserrat text-lg md:text-3xl mt-2">2.6km</p>
          <p className="text-white text-sm md:text-xl">Qendra</p>
        </div>
        <div className="flex flex-col items-center justify-center">
          <img
            src="/prishtina-view/assets/svgs/airplane.svg"
            alt=""
            className="h-12 md:h-24"
          />
          <p className="montserrat text-lg md:text-3xl mt-2">2.6km</p>
        ...
        <div className="flex flex-col items-center justify-center">
          <img
            src="/prishtina-view/assets/svgs/shopping.svg"
            alt=""
            className="h-12 md:h-24"
          />
          <p className="montserrat text-lg md:text-3xl mt-2">2.6km</p>
