...
const Building = () => {
    ...
    return (
        <div className="relative w-full h-[100vh] flex flex-col items-center justify-center">
            ...
            {selectedTab === 'selection' && popup.open && <ApartmentModal apartment={popup.data} mousePosition={mousePosition} />}
            {selectedTab === 'floor' && popup.open &&
                <>
                    <FloorPopup anchorEl={popup.anchorEl} data={popup.data} open={popup.open} />
                    <AvailableFloor anchorEl={popup.anchorEl} data={popup.data} open={popup.open} />
                </>
            }
            {contextMenu.open &&
