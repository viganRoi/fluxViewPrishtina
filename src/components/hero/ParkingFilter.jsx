        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex items-center space-x-4">
            <label className="flex items-center space-x-2 cursor-pointer">
              ...
              />
              <div
                className={`w-5 h-5 border rounded-md ${selectedType.includes("Parkingjet")
                  ? "bg-[var(--brand-color)]"
                  : "bg-white"
                  }`}
              />
            ...
            <label className="flex items-center space-x-2 cursor-pointer">
              ...
              />
              <div
                className={`w-5 h-5 border rounded-md ${selectedType.includes("Depo")
                  ? "bg-[var(--brand-color)]"
                  : "bg-white"
                  }`}
              />
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex space-x-2">
            {Object.keys(mappingParkingNumberToFloor).map((floor) => (
              <button
                key={floor}
                className={`px-4 py-2 border rounded-md ${String(parkingNumber) === floor
