...
import { fetchAllCommercialStoreAndBuilding, fetchAllCommercialStoreByBuilding, fetchCommercialStoreById, updateCommercialStore } from './CommercialStoreApi';
...
const CommercialStoreSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        .addCase(fetchCommercialStoreById.pending, (state) => {
            state.status = 'pending';
        })
        .addCase(fetchCommercialStoreById.fulfilled, (state, action) => {
            state.status = 'fulfilled';
            state.singleComercialStore = action.payload;
        })
        .addCase(fetchCommercialStoreById.rejected, (state, action) => {
            state.status = 'rejected';
            state.error = action.error.message;
            state.msg = action.payload
        })
...
export const getSingleCommercialStore = (state) => state.CommercialStoreSlice.singleComercialStore;
